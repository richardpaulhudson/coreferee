...
class EnglishSmokeTest(unittest.TestCase):
    ...
    def test_simple(self):
        self.compare_annotations(
            "I saw a dog and it was chasing a cat", "[0: [3], [5]]"
        )

    def test_simple_plural(self):
        self.compare_annotations(
            "I saw dogs and they was chasing a cat", "[0: [2], [4]]"
        )
    ...
    def test_conjunction_different_pronouns(self):
        self.compare_annotations(
            "I saw Peter and Jane, and she and he were chasing a cat",
            "[0: [2], [9], 1: [4], [7]]",
    ...
    def test_different_sentence(self):
        self.compare_annotations("I saw Peter. He was chasing a cat.", "[0: [2], [4]]")
    ...
    def test_entity_coreference(self):
        self.compare_annotations(
            "I saw Mr. Platt. Everyone liked the friendly man.", "[0: [3], [9]]"
        )

    def test_reflexive_simple(self):
        self.compare_annotations("The panther chased itself", "[0: [1], [3]]")

    def test_reflexive_coordination(self):
        self.compare_annotations(
            "The panther and the leopard chased themselves", "[0: [1, 4], [6]]"
        )
    ...
    def test_reflexive_anaphor_precedes_referent(self):
        self.compare_annotations("We discussed himself and Peter came in.", "[]")

    def test_cataphora_simple(self):
        self.compare_annotations(
            "Although he was tired, Peter went home.", "[0: [1], [5]]"
        )
