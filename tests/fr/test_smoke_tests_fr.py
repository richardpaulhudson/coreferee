...
class FrenchSmokeTest(unittest.TestCase):
    ...
    def test_simple(self):
        self.compare_annotations(
            "J'ai vu un chien et il chassait un chat", "[0: [4], [6]]"
        )

    def test_simple_plural(self):
        self.compare_annotations(
            "J'ai vu des chiens et ils chassaient des chats", "[0: [4], [6]]"
        )

    def test_simple_conjunction_same_word(self):
        self.compare_annotations(
            "J'ai vu un chien et un chien et ils chassaient des chats",
            "[0: [4, 7], [9]]",
        )
    ...
    def test_independent_propositions_different_pronouns(self):
        self.compare_annotations(
            "J'ai vu Jacques et Julie ; elle et lui, ils chassaient un chat",
            "[0: [3], [9], 1: [5], [7]]",
            excluded_nlps=["core_news_sm"],
        )
    ...
    def test_conjunction_involving_pronoun(self):
        self.compare_annotations(
            "Je voyais Jacques et Julie. Elle et Richard chassaient un chat",
            "[0: [4], [6]]",
        )

    def test_different_sentence(self):
        self.compare_annotations(
            "Je voyais Jacques. Il chassait un chat.",
            "[0: [2], [4]]",
    ...
    def test_proper_noun_coreference_multiword(self):
        self.compare_annotations(
            "Je voyais Jacques Martin. Jacques Martin chassait un chat.",
            "[0: [2], [5]]",
        )
    ...
    def test_reflexive_simple(self):
        self.compare_annotations("La panthère se chassait", "[0: [1], [2]]")
    ...
    def test_reflexive_excluded_mix_of_coordination_and_single_member_2(self):
        self.compare_annotations(
            "Jacques et Julie entrèrent. Ils les virent.", "[0: [0, 2], [5]]"
        )
    ...
    def test_reflexive_noun(self):
        self.compare_annotations(
            "Il est passioné par la rotation sur elle-même de la Terre", "[0: [5], [7]]"
        )
