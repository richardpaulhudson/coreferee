...
class CommonAnnotationTest(unittest.TestCase):
    ...
    def test_annotations_coordination(self):
        self.compare_annotations(
            "Richard and Peter said they had finished", "[0: [0, 2], [4]]"
        )

    def test_annotations_coordination_with_or(self):
        self.compare_annotations(
            "There were two men. Richard or Peter said he had finished", "[0: [5], [9]]"
        )
    ...
    def test_annotations_cataphora(self):
        self.compare_annotations(
            "Although he was still working, Richard said hello", "[0: [1], [6]]"
        )

    def test_annotations_cataphora_and_coordination(self):
        self.compare_annotations(
            "Although they were still working, Richard and Peter said hello",
            "[0: [1], [6, 8]]",
        )

    def test_annotations_cataphora_and_anaphora(self):
        self.compare_annotations(
            "Although he was still working, Richard said he had finished",
            "[0: [1], [6], [8]]",
        )
    ...
    def test_annotations_nouns_simple(self):
        self.compare_annotations(
            "Richard was here. Richard had finished", "[0: [0], [4]]"
        )

    def test_annotations_nouns_and_pronouns_mixed_(self):
        self.compare_annotations(
            "He was here. Richard was here. Richard had finished. He was here. Richard was here. He saw him.",
            "[0: [0], [22], 1: [4], [8], [12], [16], [20]]",
    ...
    def test_non_reflexive_allowed_in_reflexive_position(self):
        self.compare_annotations(
            "Richard came in. The wind saw himself", "[0: [0], [7]]"
        )

    def test_two_pronouns_previous_noun(self):
        self.compare_annotations(
            "Richard came in. Someone saw him. He was ready", "[0: [0], [6], [8]]"
        )

    def test_sentence_referential_distance_pronoun(self):
        self.compare_annotations(
            "Richard came in. Yes. Yes. Yes. Yes. Yes. Someone saw him.", "[]"
        )

    def test_sentence_referential_distance_with_spanning_pronoun(self):
        self.compare_annotations(
            "Richard came in. Yes. Yes. Someone saw him. Yes. Yes. Yes. Someone saw him.",
            "[0: [0], [10], [20]]",
        )
    ...
    def test_sentence_referential_distance_noun_with_spanning_pronoun(self):
        self.compare_annotations(
            "Richard came in. Yes. Someone saw him. Yes. Richard came in.",
            "[0: [0], [8], [12]]",
        )
    ...
    def test_retry(self):
        self.compare_annotations(
            "The dog saw the house. It saw him.", "[0: [1], [8], 1: [4], [6]]"
        )

    def test_retry_control(self):
        self.compare_annotations(
            "The dog saw the person. It saw him.", "[0: [1], [6], 1: [4], [8]]"
        )
    ...
    def test_reflexive_excluded_mix_of_coordination_and_single_member_1(self):
        self.compare_annotations(
            "Peter and Jane came in. They saw him.", "[0: [0, 2], [6]]"
        )

    def test_reflexive_excluded_mix_of_coordination_and_single_member_2(self):
        self.compare_annotations(
            "Peter and Jane came in. They saw her.", "[0: [0, 2], [6]]"
        )
    ...
    def test_reflexive_excluded_mix_of_coordination_and_single_member_3(self):
        self.compare_annotations(
            "Peter and Jane came in. He saw them.", "[0: [0], [6]]"
        )

    def test_reflexive_excluded_mix_of_coordination_and_single_member_4(self):
        self.compare_annotations(
            "Peter and Jane came in. She saw them.", "[0: [2], [6]]"
        )
