...
class CommonDataModelTest(unittest.TestCase):
    ...
    def test_representations_doc(self):
        ...
        self.assertEqual(0, doc[0]._.coref_chains[0].most_specific_mention_index)
    ...
    def test_representations_token(self):
        ...
        self.assertEqual(
            "0: Peter(2), He(4); 1: [He(4); Richard(6)], They(10)",
        ...
        self.assertEqual(
            "0: Peter(2), He(4)", doc[2]._.coref_chains.pretty_representation
        )

        self.assertEqual("[1: [4, 6], [10]]", str(doc[10]._.coref_chains))
        self.assertEqual(
            "1: [He(4); Richard(6)], They(10)",
            doc[10]._.coref_chains.pretty_representation,
        )

        self.assertEqual(0, doc._.coref_chains[0].most_specific_mention_index)
        self.assertEqual(0, doc._.coref_chains[1].most_specific_mention_index)
    ...
    def test_representations_cataphora(self):
        ...
        self.assertEqual(1, doc._.coref_chains[0].most_specific_mention_index)
    ...
    def test_resolve_recursive(self):
        doc = self.sm_nlp(
            "I spoke to Mr. Platt. The man and Richard came in. They and Peter said hello. They were all here."
        )
