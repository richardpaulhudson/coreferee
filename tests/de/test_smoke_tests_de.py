...
class GermanSmokeTest(unittest.TestCase):
    ...
    def test_simple(self):
        self.compare_annotations(
            "Ich sah einen Hund, und er jagte eine Katze", "[0: [3], [6]]"
        )
    ...
    def test_simple_conjunction_same_word(self):
        self.compare_annotations(
            "Ich sah einen Hund und einen Hund, und sie jagten eine Katze",
            "[0: [3, 6], [9]]",
    ...
    def test_different_sentence(self):
        self.compare_annotations("Ich sah Peter. Er jagte eine Katze.", "[0: [2], [4]]")
    ...
    def test_proper_noun_coreference_multiword_only_first_repeated(self):
        self.compare_annotations("Ich sah Peter Paul. Peter jagte eine Katze.", "[]")

    def test_proper_noun_coreference_with_gender_difference(self):
        self.compare_annotations(
            "Er arbeitete bei der BMW AG. Das Unternehmen gefiel ihm. Es hatte viel Erfolg auf dem deutschen Markt",
            "[0: [0], [10], 1: [4], [8], [12]]",
    ...
    def test_reflexive_simple(self):
        self.compare_annotations("Der Gepard jagte sich", "[0: [1], [3]]")

    def test_reflexive_coordination(self):
        self.compare_annotations(
            "Der Gepard und der Leopard jagten sich", "[0: [1, 4], [6]]"
        )

    def test_reflexive_excluded_mix_of_coordination_and_single_member_1(self):
        self.compare_annotations(
            "Peter und Jana kamen rein. Sie sahen ihn.", "[0: [0, 2], [6]]"
        )

    def test_reflexive_excluded_mix_of_coordination_and_single_member_2(self):
        self.compare_annotations(
            "Peter und Jana kamen rein. Sie sahen sie.", "[0: [0, 2], [6]]"
        )
    ...
    def test_cataphora_simple(self):
        self.compare_annotations(
            "Obwohl er müde war, ging Peter nach Hause", "[0: [1], [6]]"
        )
    ...
    def test_possessive_pronoun_within_threeway_coordination(self):
        self.compare_annotations(
            "Wir sahen Peter, seine Frau und seine Kinder.", "[0: [2], [4], [7]]"
        )
    ...
    def test_pronominal_anaphor(self):
        self.compare_annotations(
            "Sie fand ein Messer und aß damit einen Apfel.", "[0: [3], [6]]"
        )
    ...
    def test_documentation_example(self):
        self.compare_annotations(
            ...
            "[0: [1], [3], [10], [14], [16], 1: [4], [11], 2: [14, 17], [22], [29], [36], 3: [32], [38]]",
